...
# This uniquely identifies your Azure AD tenant. We have already filled this in for you.
variable "tenant_id" { 
 type = string 
...
# You can find it in the Azure portal under "Subscriptions" > "Subscription ID". Details below.
